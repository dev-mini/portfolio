...
export const experience = [
  {
    ...
    Durante mi jornada estuve apoyando activamente con React tanto en TypeScript como en JavaScript, además de Kotlin para el desarrollo de aplicaciones android; contribuyendo al desarrollo de componentes reutilizables asegurando una buena experiencia de usuario y un buen rendimiento, manteniendo un código limpio y escalable. También tuve una participación constante en el desarrollo backend con Express y FastAPI utilizando bases de datos como PostgreSQL y MongoDB durante unos meses; generando REST API endpoints y documentando la Api con Swagger para facilitar su uso.`,
